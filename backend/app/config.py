...
DEFAULT_APP_CONFIG = {
    ...
    # ВНИМАНИЕ: на исторических данных уверенность анти-предиктивна
    # (corr(confidence, win) = -0.093; выше 75% winrate падает до 25%),
    # поэтому порог режет ШУМ, но не повышает качество сигналов.
    "market_scan_min_confidence": 80,
