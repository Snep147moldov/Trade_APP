...
# невиденных данных (E[R] +0.149, PF 1.26).
# 15m убран по факту: 30 сделок, winrate 30%, -181 EUR — худший и по доле
# выигрышей, и по деньгам. 4h и 1d убраны 30 августа: они никогда не
# проверялись с исправленными знаками, а expiry_bars=96 на дневных барах
